...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::journal_scroll::get_journal_scroll_files,
            commands::composer::merge_notes,
            commands::composer::split_note,
            commands::export::export_note_pdf,
            commands::export::export_note_pdf_to_file,
            commands::export::export_self_contained_typ,
            commands::export::export_note_html,
            commands::export::export_collection_note_pdf,
            commands::export::export_collection_batch_pdf,
            commands::export::export_collection_book_pdf,
            commands::typ_audit::audit_typ_files,
            commands::typ_audit::repair_typ_files,
            commands::export::export_collection_static_site,
            commands::export::export_collection_csv,
            commands::export::export_collection_csv_to_file,
            commands::export::detect_pandoc,
            commands::export::export_via_pandoc,
            commands::export::export_figures,
