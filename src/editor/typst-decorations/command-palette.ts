...
const PALETTE_ITEMS: PaletteItem[] = [
  ...
  { label: "Annotation", category: "InkyCap", insert: '#annotation[${sel}]', cursorOffset: 12, expandOnInsert: true, shortcut: "{>>…<<}" },
  { label: "Suggest insertion", category: "InkyCap", insert: '#suggestion(kind: "insert")[${sel}]', cursorOffset: 28, shortcut: "{++…++}" },
  { label: "Suggest deletion", category: "InkyCap", insert: '#suggestion(kind: "delete")[${sel}]', cursorOffset: 28, shortcut: "{--…--}" },
  { label: "Suggest replacement", category: "InkyCap", insert: '#suggestion(kind: "replace", old: [${sel}])[]', cursorOffset: 35, shortcut: "{~~…~>…~~}" },
