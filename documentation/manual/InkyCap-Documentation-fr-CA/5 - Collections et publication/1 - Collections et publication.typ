...
#note(
  title: "Collections et publication",
  description: "Vue d'ensemble de la section : les collections et la publication dans InkyCap.",
  tags: ("documentation",),
...
- créer des espaces de travail pour vos projets de publication.

Les outils de publication prennent une seule note ou une collection entière et produisent quelque chose que vous pouvez remettre, soumettre ou mettre en ligne.
\
