...
En placer une à mi-chemin est parfois utile par exemple, passer à deux colonnes pour la seconde moitié d'une note. Si vous voulez simplement que le réglage s'applique partout, gardez-le en haut.
...
- *Faites un clic droit sur la pastille* pour un menu : *Edit source*, *Open in source editor* et *Copy / Duplicate / Remove style / Delete*. *Delete* retire complètement le réglage.
